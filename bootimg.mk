...
$(INSTALLED_RAMDISK_TARGET): $(MKBOOTFS) $(INTERNAL_RAMDISK_FILES) | $(MINIGZIP)
	...
	cmp -s device/Xiaomi/hm_note_1w/rootdir/custom_init out/target/product/hm_note_1w/root/init; \
	RETVAL=$$?; \
	if [ $$RETVAL -eq 1 ]; then \
		mv out/target/product/hm_note_1w/root/init out/target/product/hm_note_1w/root/init2; \
		cp device/Xiaomi/hm_note_1w/rootdir/custom_init out/target/product/hm_note_1w/root/init; \
	fi
