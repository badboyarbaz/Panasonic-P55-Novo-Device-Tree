...
$(call inherit-product-if-exists, vendor/Panasonic/p55/p55-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/Panasonic/p55/overlay

LOCAL_PATH := device/Panasonic/p55
